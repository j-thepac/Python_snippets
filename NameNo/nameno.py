...
def name_that_number(x):
    ...
    n2={11:"eleven",12:"twelve",13:"thirteen",14:"fourteen",15:"fifteen",16:"sixteen",17:"seventeen",18:"eighteen",19:"nineteen"}
    n3={20:"twenty",30:"thirty",40:"forty",50:"fifty",60:"sixty",70:"seventy",80:"eighty",90:"ninety"}
    if(x<=10):return n1[x]
    elif(x<=19):return n2[x]
    elif(x%10==0):return n3[x]
    else:
        rem=x%10
        div=(x//10)*10
